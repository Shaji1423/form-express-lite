...
export const Route = createFileRoute("/user-login")({
  head: () => ({ meta: [{ title: "Student Login — Campus Life" }] }),
  component: UserLogin,
});
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background px-5 py-10">
      ...
      >
        ...
        <h1 className="text-2xl font-semibold text-foreground">Student Login</h1>
        <p className="mt-1 text-sm text-muted-foreground">Sign in to register for events and proshows.</p>
        ...
        <input
          ...
          placeholder="you@srmeaswari.ac.in"
        />
